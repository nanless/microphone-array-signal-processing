#!/usr/bin/env python3
"""把 拆分版/ 12 篇 Markdown 建成多级页面静态站，输出到 site/。

用法（报告根目录）：
    .venv/bin/python Scripts/build_site.py

产物：site/index.html（首页）+ site/01..11_*.html（11 篇正文），
左侧边栏 = 首页 + 11 篇 + 每篇的二级/三级小节锚点，顶部面包屑，
...
CHAPTERS = [
    ("01_问题定义与双耳启示.md", "第 1 篇 · 问题定义与双耳启示"),
    ("02_基础_声音到达阵列时发生了什么.md", "第 2 篇 · 声音到达阵列时发生了什么"),
    ("03_阵列几何形态.md", "第 3 篇 · 阵列几何形态"),
    ("04_声源定位DOA估计.md", "第 4 篇 · 声源定位（DOA 估计）"),
    ("05_波束形成Beamforming.md", "第 5 篇 · 波束形成"),
    ("06_声学回声消除AEC.md", "第 6 篇 · 声学回声消除（AEC）"),
    ("07_去混响WPE.md", "第 7 篇 · 去混响（WPE）"),
    ("08_语音分离.md", "第 8 篇 · 语音分离"),
    ("09_声源追踪SourceTracking.md", "第 9 篇 · 声源追踪"),
    ("10_工程实现评测与产业实践.md", "第 10 篇 · 工程实现与产业实践"),
    ("11_总结与选型指南.md", "第 11 篇 · 总结与选型指南"),
    ("12_附录A_符号术语数学.md", "附录 A · 符号术语数学"),
    ("13_附录B_路径地图前沿踩坑练习复现.md", "附录 B · 路径地图与练习"),
]
HOME_FNAME = "00_首页_导读与导航.md"

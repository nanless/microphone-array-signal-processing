...
| 编号 | 文件 | 配图 | 难度 | 预计时间 |
|---|---|---|---|---|
| 00 | `00_overview.md`（本页） | — | 入门 | 15～20 分钟，先读本页 |
...
| 07 | `07_wpe-dereverberation.md` | 图21、图24，共 2 张，另引用图23（全书链路总图） | 较难 | 30～45 分钟 |
| 08 | `08_speech-separation.md` | 0 张专属图，引用图23（全书链路总图） | 较难 | 30～45 分钟 |
| 09 | `09_source-tracking.md` | 引用 2 张图（图22 是本章的，图23 是全书链路总图） | 进阶 | 30～40 分钟 |
| 10 | `10_engineering-practice.md` | 新图 1 张（图25），另引用图23 | 进阶 | 20～30 分钟 |
| 11 | `11_selection-guide.md` | 0 | 入门 | 5 分钟，11.1 总纲→11.2 场景表→11.3 决策树→11.4 练习→11.5 分流，选方案时直接查 |
| 12 | `12_appendix-symbols-math.md` | 0 | 入门 | 通读约 25 分钟，也可以当词典查 |
| 13 | `13_appendix-guide.md` | 0 | 入门到进阶 | 通读约 40 分钟，也可以按需查 |

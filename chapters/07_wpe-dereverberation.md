> ⚠️ 本篇是系列教程第 7 篇（共 13 篇），可独立阅读，前后篇见下方导航。
>
...
| 预测（WPE/在线 WPE） | Nakatani et al. 2010 | 晚期混响拖尾 | 倒谱 liftering（单通道轻量） | 约 15~30%（离线版） | 整句批处理；在线版帧级、性能打折扣 | 中（迭代 2~5 次） | 不动直达与早期反射；短语音迭代不足 |
...
神经先验三条（物理骨架保留，DNN 换先验）：即插即用数据先验 PnP-WPE（把学到的话音先验塞进 WPE 迭代，复杂含噪更稳，预印本）；VINP（已推进到 v3 并投稿 TASLP：任意判别式 DNN 当干净语音先验，变分贝叶斯联合估计干净谱与滤波，还能盲辨房间冲激响应，单通道主客观双优且不伤识别）；VACE-WPE（预印本，神经网络脑补虚拟通道，让单麦克风吃上双通道红利）。[PnP-WPE](https://arxiv.org/abs/2312.02773 "citation")、 [VINP](https://arxiv.org/abs/2502.07205 "citation")、 [VACE-WPE](https://arxiv.org/abs/2102.05259 "citation")

...
α-β / α-β-γ 滤波器采用固定更新增益，因而在线更新可以不反复求解 Riccati 递推。如果模型、采样周期和噪声统计恒定，且固定增益取为对应卡尔曼滤波的稳态增益，它可以等价于该模型下的稳态卡尔曼滤波。经验选取的固定增益则不保证这种最优性；模型或噪声条件变化时，固定增益也不会自行重新适配。α-β 的稳态关系见 [Ekstrand, *Some Aspects on Filter Design for Target Tracking*, §9.1](https://doi.org/10.1155/2012/870890 "citation")；α-β-γ 的增益稳定性和优化条件见 [Kosuge 与 Ito, *Stability of an α-β-γ Filter and Optimal Gains*, 2002](https://doi.org/10.9746/sicetr1965.38.361 "citation")。

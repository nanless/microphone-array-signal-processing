...
实现时还要记录分段与重叠处理、标记规则，以及固定的评分工具版本或提交。本文核实于 2026-09-21，并将算法说明钉在 MeetEval 提交 [`6e3dc81284f2d6928f7ef9e620fd3b6906daa429`](https://github.com/fgnt/meeteval/blob/6e3dc81284f2d6928f7ef9e620fd3b6906daa429/doc/algorithms.md)；复现实验也应记录实际安装包版本或完整提交号，不能只写会移动的 `main`。

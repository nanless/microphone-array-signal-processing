...
**四词手算：两条流在第二段交换。** 下表每个“某词”都是一个独立词元；每段中甲、乙同时说话，分离器第二段把两人放进了相反的输出槽位。本例只比较词内容与流分配，不涉及分词歧义或时间容差。
...
按说话人拼接的参考是甲流“甲词 丙词”和乙流“乙词 丁词”；实际输出分别是流 1“甲词 丁词”、流 2“乙词 丙词”。四个词的内容都在输出中，但第二段换了流。

cpWER 只能为**整条**输出流选择一次全局排列。不交换流时，甲流的“丙词→丁词”和乙流的“丁词→丙词”各产生一次替换；交换两条流也各有一次替换，因此最小编辑数为 2，参考总词数为 4，cpWER 为 $2/4=50\%$。

ORC-WER 按**参考语句**选择输出流：第一段的“甲词”给流 1、“乙词”给流 2，第二段的“丙词”给流 2、“丁词”给流 1。两条重组参考流于是分别等于两条输出流，编辑数为 0，ORC-WER 为 $0/4=0\%$。

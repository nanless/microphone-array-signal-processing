...
6. **TF-GridNet 与复数谱映射骨干**：TF-GridNet（IEEE/ACM TASLP 2023）最初用于单通道说话人分离，后续多通道方法也借用了其帧内、帧间双路径结构。具体 SI-SDRi 必须按原文的 WSJ0-2mix 版本、混合方式和表号引用。[TF-GridNet, arXiv:2209.03952](https://arxiv.org/abs/2209.03952 "citation") TF-Locoformer（IWAENC 2024）用包含卷积前馈网络和注意力的结构替换循环模块。[TF-Locoformer, arXiv:2408.03440](https://arxiv.org/abs/2408.03440 "citation")

...
这里的 40 个 WAV 分成 10 组，由 `codes/examples/generate_audio_samples.py` 生成，使用 16 kHz、16 位 PCM。前六组使用种子 20260922，相关噪声、极性和病态求逆三组使用独立随机流 20260923，不改变前六组波形；非线性回声组没有随机输入。

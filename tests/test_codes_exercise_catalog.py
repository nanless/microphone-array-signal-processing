"""Explicit cross-module, chapter and research inventory for 67 exercises."""
...
class ExerciseCatalogTest(unittest.TestCase):
    ...
    def test_independent_inventory_has_67_unique_ids(self):
        self.assertEqual(len(ALL_IDS), 67)
        self.assertEqual(sum(map(len, EXPECTED.values())), 67)
    ...
    def test_chapter_and_research_inventories_cover_exactly_67_ids(self):

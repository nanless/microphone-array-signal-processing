...
class ResearchQualityTests(unittest.TestCase):
    ...
    def test_explicit_baselines_preserve_tutorial_pdf_and_figure_counts(self):
        ...
        self.assertEqual(quality.EXPECTED_SUBSECTION_COUNT, 141)
        self.assertEqual(quality.EXPECTED_OUTLINE_ITEM_COUNT, 274)
        self.assertEqual(quality.EXPECTED_FIGURE_NUMBERS, set(range(1, 41)))

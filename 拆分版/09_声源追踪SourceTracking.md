> ⚠️ 本篇是系列教程第 9 篇（共 13 篇），可独立阅读，前后篇见下方导航。
>
> 🏠 首页导读：[`00_首页_导读与导航.md`](./00_首页_导读与导航.md) ｜ 上一篇：[08_语音分离.md](./08_语音分离.md) ｜ 下一篇：[10_工程实现评测与产业实践.md](./10_工程实现评测与产业实践.md)
...
![图23 前端处理链路](../figures/fig23_pipeline.png)
...
> 📄 本篇信息：约 222 行 ｜ 字符约 13755 ｜ 配图 2 张 ｜ [回首页](./00_首页_导读与导航.md)
